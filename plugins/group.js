...
cmd({
    ...
    use: '.kick',
    filename: __filename
}, async (conn, mek, m, { from, mentionByTag, isOwner, isGroup, isAdmins, isMe, isBotAdmins, reply }) => {
    try {
        if (!isGroup) return reply("⛔ *Group Only Command*\nThis command works only in groups.");
        if (!isAdmins && !isMe && !isOwner) return reply("⚠️ *Permission Denied*\nYou must be a group admin to use this.");
        if (!isBotAdmins && !isOwner) return reply("❌ *Bot Lacks Permission*\nMake me an admin to perform this action.");
...
cmd({
    ...
    use: '.promote',
    filename: __filename
}, async (conn, mek, m, { from, mentionByTag, isGroup, isOwner, isAdmins, isMe, isBotAdmins, participants, reply }) => {
    try {
        if (!isGroup) return reply("⛔ *Group Only Command*");
        if (!isAdmins && !isMe && !isOwner) return reply("⚠️ *Permission Denied*");
...
cmd({
    ...
    use: '.demote',
    filename: __filename
}, async (conn, mek, m, { from, mentionByTag, isGroup, isAdmins, isOwner, isMe, isBotAdmins, participants, reply }) => {
    try {
        if (!isGroup) return reply("⛔ *Group Only Command*");
        if (!isAdmins && !isMe && !isOwner) return reply("⚠️ *Permission Denied*");
        if (!isBotAdmins) return reply("❌ *Bot Lacks Permission*");
...
cmd({
    ...
    use: '.mute',
    filename: __filename
}, async (conn, mek, m, { from, isGroup, isBotAdmins, isOwner, isAdmins, isMe, reply }) => {
    try {
        if (!isGroup) return reply("⛔ *Group Only Command*");
        if (!isBotAdmins && !isOwner) return reply("❌ *Bot Lacks Permission*");
        if (!isAdmins && !isMe && !isOwner) return reply("⚠️ *Permission Denied*");
...
cmd({
    ...
    react: "➕",
    filename: __filename
}, async (conn, mek, m, { from, q, isGroup, isAdmins, isOwner, isBotAdmins, isMe, reply }) => {
    try {
        if (!isGroup) return reply("⛔ *Group Only Command*");
        if (!isBotAdmins && !isOwner) return reply("❌ *Bot Lacks Permission* - Make me an admin first.");
        if (!isAdmins && !isMe && !isOwner) return reply("⚠️ *Permission Denied* - Only admins can use this command.");
...
cmd({
    ...
    react: "📌",
    filename: __filename
}, async (conn, mek, m, { from, isGroup, isOwner, isAdmins, isBotAdmins, isMe, quoted, reply }) => {
    try {
        if (!isGroup) return reply("⛔ *Group Only Command*");
        if (!isBotAdmins) return reply("❌ *Bot must be admin to pin messages.*");
        if (!isAdmins && !isMe && !isOwner) return reply("⚠️ *Permission Denied* - Only admins can use this.");
