...
const getGroupAdmins = (participants) => {
	...
	for (const participant of participants) {
		// Check if the participant has an 'admin' role, e.g., 'admin' or 'superadmin'
		if (participant.admin) {
			// Push all three IDs for the admin participant
			admins.push(participant.id)
			admins.push(participant.lid)
			admins.push(participant.jid)
		}
	}
	return admins
}
