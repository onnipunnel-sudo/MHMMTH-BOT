...
const settingsSchema = new mongoose.Schema({
  OWNER_NUMBER: { type: String, default: "94720610686" },
  MV_SIZE: { type: String, default: "0" },
  NAME: { type: String, default: "★━━━━━━━━✩━━━━━━━━★" },
  CAPTION: { type: String, default: "*💃🏻NADEEN MV*" },
  DOC: { type: String, default: "🎬NADEEN🎬" },
  UPLODER: { type: String, default: "Nadeen Poorna" },
  JID: { type: String, default: "" },
  PAY: { type: String, default: "203367389343836" },
...
SUDO: { type: [String], default: [] },
  ...
  MAX_SIZE: { type: Number, default: 1900 },
  ...
  WORK_TYPE: { type: String, default: "only_group" },
  ...
  MV_BLOCK: { type: String, default: "false" },
    BUTTON: { type: String, default: "false" },
  ACTION: { type: String, default: "delete" },
  SIN_LINK: { type: String, default: "" },
  AUTO_SIN: { type: String, default: "false" },
  LINK: { type: String, default: "https://chat.whatsapp.com/EbVvjzc9PhSH6mcfKAfZWl" },
  ANTILINK_ACTION: { type: String, default: "delete" },
  VALUSE: { type: [String], default: [] },
LOGO: { 
  type: String, 
  default: "hhttps://nadeen-botzdatabse.nadeenpoornanew.workers.dev/MOVIExGO.png" 
},
